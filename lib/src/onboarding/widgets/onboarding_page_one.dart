...
class OnboardingScreenOne extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: ScreenUtil().screenHeight, // Ensure full height
      child: Stack(
        children: [
          Image.asset(
            ...
            height: ScreenUtil().screenHeight, // Make image cover full height
          ),
          Positioned(
            bottom: 150.h,
            left: 30.w,
            ...
            child: Text(
              ...
              style: appStyle(11.sp, Kolors.kGray, FontWeight.normal),
            ),
          ),
        ],
      ),
